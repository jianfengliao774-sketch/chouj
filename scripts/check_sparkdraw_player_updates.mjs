...
if(!report.refundRoundInputRemoved||!report.siteClock||!report.privateKeyInput||!report.importReady||report.rounds.some(r=>!/^\d{12,}$/.test(r.displayRoundId)))throw Error('Live update check failed');
