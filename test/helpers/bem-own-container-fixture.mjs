...
const BASE = 'contracts/production-v3/BemSelectableRaffleV3.sol';
...
async function setup(t, denomination = 100, options = {}) {
  ...
  const c = JSON.parse(readFileSync(ROOT + 'outputs/bem-raffle-2075/production-v3/' + artifactName, 'utf8'));
