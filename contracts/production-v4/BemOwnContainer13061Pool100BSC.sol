...
/// @notice Fixed 100 BEM / 10000 tickets. V4 production denomination; 5000 tickets per purchase.
...
contract BemOwnContainer13061Pool100BSC is BemOwnContainer13061SeriesBSC {
    ...
    constructor(uint256 vrfSubscriptionId,uint16 confirmations,uint32 vrfCallbackGasLimit)
        BemOwnContainer13061SeriesBSC(vrfSubscriptionId,confirmations,vrfCallbackGasLimit,10000000000) {}
}
