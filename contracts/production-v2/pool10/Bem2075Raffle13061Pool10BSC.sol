...
/// @notice Fixed 10 BEM / 10000 tickets. Production denomination.
...
contract Bem2075Raffle13061Pool10BSC is BemContainer13061SeriesBSC {
    ...
    constructor(uint256 vrfSubscriptionId,uint16 confirmations,uint32 vrfCallbackGasLimit)
        BemContainer13061SeriesBSC(CIRCUITS,CIRCUIT_ID,BEHEMOTH_2075_CONTAINER,
            vrfSubscriptionId,confirmations,vrfCallbackGasLimit,1000000000) {}
}
